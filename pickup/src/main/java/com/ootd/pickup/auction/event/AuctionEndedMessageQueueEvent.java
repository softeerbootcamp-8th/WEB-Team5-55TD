 ...
 *
 * <p>같은 사건을 화면에 실시간으로 알리는 용도로는 {@link AuctionEndedNotificationEvent}를 쓴다.
 */
public record AuctionEndedMessageQueueEvent(
    String eventId,
    Long auctionId,
    Long consignmentId,
    Long sellerMemberId,
  ...
  public static AuctionEndedMessageQueueEvent fromEntity(Auction auction, Bid winningBid) {
