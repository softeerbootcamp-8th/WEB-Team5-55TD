...
public class CardService {
  ...
  public GetCardDetailResponse getCardDetail(Long cardId) {
    Card card =
        cardRepository.findCardById(cardId).orElseThrow(() -> new PickUpException(CARD_NOT_FOUND));
  ...
  public CursorPageResponse<SearchCardsResponse, Long> searchCards(
    ...
    List<Card> cards =
        hasNext ? searchedCards.subList(0, searchCardsRequest.size()) : searchedCards;
