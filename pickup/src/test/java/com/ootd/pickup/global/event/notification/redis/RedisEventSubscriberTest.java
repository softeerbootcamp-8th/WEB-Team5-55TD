...
class RedisEventSubscriberTest {
  ...
  private RedisEventSubscriber createSubscriber(
    ...
    RedisEnvelopeReader envelopeReader = new RedisEnvelopeReader(objectMapper);
    RedisChannelResolver channelResolver = new RedisChannelResolver();
  ...
  private RedisEnvelope envelopeOf(AuctionBidUpdatedNotificationEvent event) {
